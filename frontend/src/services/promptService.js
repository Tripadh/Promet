...
export const promptService = {
  ...
  improvePromptStream: async (prompt, mode, isRetry, onToken, onDone, conversationId = null, domain = null) => {
    ...
    const response = await fetch(`${API_BASE_URL}/prompts/improve`, {
      ...
      body: JSON.stringify({ prompt, mode, isRetry, conversationId, domain })
    });
